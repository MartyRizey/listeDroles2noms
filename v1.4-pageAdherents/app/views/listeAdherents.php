...
<section id="adherentsList">
    ...
    -->   
    <button type="button" class="btn btn-primary btn-displayDataSubmit " data-toggle="modal" data-target="#exampleModal" href="modalDatasSubmit.php">Dernières données soumisent</button>
