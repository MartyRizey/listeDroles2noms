...
<section class="article article_1">
    <div class="row">
        ...
        <img src="http://localhost/programmation/repos_github/droleDeNom/v1.5-suppDonnees/public/assets/imgs/trecon.jpeg" alt="panneau nom de la ville" class="photoArticle1 col-xl-3">
    </div>
</section>
<hr>
<section class="article article_2">
    <div class="row">
        <img src="http://localhost/programmation/repos_github/droleDeNom/v1.5-suppDonnees/public/assets/imgs/arnacLaPoste.jpeg" alt="panneau nom de la ville" class="photoArticle2 col-xl-4">
